...
faceFront.style.transform = 'perspective(500px) rotateY(0deg)';
faceBack.style.transform = 'perspective(500px) rotateY(180deg)';
...
cardPreview.addEventListener('click', ()=> {
    ...
    if (faceFront.style.transform != 'perspective(500px) rotateY(0deg)') {
        ...
        faceFront.style.transform = 'perspective(500px) rotateY(180deg)';
        faceBack.style.transform = 'perspective(500px) rotateY(360deg)';
